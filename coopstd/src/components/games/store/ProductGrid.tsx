...
const ProductGrid = ({
  ...
  const isSpecialItem = (productId: number) => {
    return [21, 22, 23].includes(productId);
  };
            ...
            <div className="space-y-3">
              ...
              <div className="pt-3 border-t">
                ...
                <Button 
                  ...
                  className={`w-full mt-2 ${isSpecialItem(product.id) ? 'bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600' : 'bg-purple-500 hover:bg-purple-600'}`}
                  size="sm"
